...
# UtilsR <a href="https://hui950319.github.io/UtilsR/"><img src="man/figures/logo.png" align="right" height="138" /></a>

<!-- badges: start -->
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)
[![R-CMD-check](https://img.shields.io/badge/R--CMD--check-passing-brightgreen.svg)](https://github.com/HUI950319/UtilsR)
...
<details>
<summary>Optional dependencies for special chart types</summary>
...
- **`fct_cat()`** -- Recode, reorder, reverse, binarise, group, and combine factors in one call
...
<details>
<summary><code>plt_cat()</code> parameter reference</summary>
